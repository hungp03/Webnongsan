							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6">
									<div class="checkout__order">
										...
										<div class="checkout__order__total">
											Tổng <span>
												<fmt:formatNumber value='${totalPrice + 15000 }' type='currency'
													currencySymbol='đ' maxFractionDigits='0' />
											</span>
										</div>
										...
										<form id="paymentForm" onsubmit="return validateForm()">
											...
											<div>
												...
												<span class="checkmark"></span> <label for="banking">Chuyển
													khoản</label>
											</div>
											...
											<button type="submit" class="site-btn btn ${isDisabled}" ${isDisabled}
												id="paymentButton">Thanh toán</button>
										</form>
									</div>
