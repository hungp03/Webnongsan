		...
		<div class="container">
			...
			<div class="row justify-content-center align-items-center">
				...
				<div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
					...
					<form id="userbean" class="pt-2" action="mailer/forgotPassword/validateCode.htm" method="post">
						<div class="row g-3">
							<!-- row -->

							<div class="col-12">
								<!-- input -->
								<input name="validateCode" placeholder="Validate Code"
									type="text" class="form-control" required/>
							</div>
							<c:if test="${not empty wrongCode}">
								<div class="col-12">
									<span style="color:red">${ wrongCode}</span>
								</div>
							</c:if>
							<!-- btn -->
							<div class="col-12 d-grid">
								<button
									class="btn btn-success btn-block  mb-3" type="submit">Tiếp Theo</button>
							</div>
