								...
								<div class="row mb-4">
									<div class="col-md-12">
										<div class="d-md-flex justify-content-between align-items-center">
											...
											<div>
												<a href="admin/products/create-product.htm" class="btn btn-custom">Thêm
													sản phẩm</a>
											</div>
										</div>
									</div>
										...
										<div class="px-6 py-6">
											<div class="row justify-content-between">
												<div class="col-lg-4 col-md-6 col-12 mb-2 mb-md-0">
													<form class="d-flex" role="search" action="admin/products.htm">
									...
									<nav>
										<ul class="pagination d-flex justify-content-center ms-2">
											...
											<c:forEach var="i" begin="1" end="${paginate.totalPage}" varStatus="in">
												<li class="page-item">
													<c:url var="pageURL" value="admin/products.htm">
