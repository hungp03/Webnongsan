										...
										<div class="px-6 py-6">
											<div class="row justify-content-between">
												<div class="col-lg-4 col-md-6 col-12 mb-2 mb-md-0">
													<form class="d-flex" role="search" action="admin/feedback.htm">
												...
												<div class="col-xl-2 col-md-4 col-12 d-flex flex-col">
													...
													<div class="dropdown">
														...
														<ul class="dropdown-menu">
															...
															<li><a class="dropdown-item" href="${baseURL}">Tất cả</a>
															</li>
															<li><a class="dropdown-item"
																	href="${baseURL}${separator}star=1">1</a></li>
															<li><a class="dropdown-item"
																	href="${baseURL}${separator}star=2">2</a></li>
															<li><a class="dropdown-item"
																	href="${baseURL}${separator}star=3">3</a></li>
															<li><a class="dropdown-item"
																	href="${baseURL}${separator}star=4">4</a></li>
															<li><a class="dropdown-item"
																	href="${baseURL}${separator}star=5">5</a></li>
														</ul>
													</div>
												</div>
											</div>
												...
												<tr>
													...
													<td class="align-middle"><a
															href="product-detail.htm?productId=${item.product.productId }"><img
																style="width: 100px"
																src="assets/user/img/products/${item.product.image}" /></a>
													</td>
													...
													<td class="align-middle">
														<div class="text-truncate">${item.feedbackContent}</div>
													</td>
													...
													<td class="align-middle">
													<form action="admin/feedback/changestatus.htm?id=${item.feedbackId }" method="post">
													<button
								...
								<nav>
									<ul class="pagination d-flex justify-content-center ms-2">
										...
										<c:forEach var="i" begin="1" end="${paginate.totalPage}" varStatus="in">
											<li class="page-item">
												<c:url var="pageURL" value="admin/feedback.htm">
