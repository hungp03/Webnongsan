							...
							<div class="container">
								<div class="row mt-3">
											...
											<div>
												...
												<nav aria-label="breadcrumb">
													<ol class="breadcrumb mb-0 text-muted fs-6 fw-semibold">
														...
														<li class="breadcrumb-item "><a href="admin/category.htm"
																class="brc-link">Danh mục</a>
									...
									<div class=" col-md-6 offset-md-3 card p-5 mb-5">
										<form:form action="${actionString }" method="post" modelAttribute="${nameBean }"
											...
											<c:if test="${not empty updateCate }">
												<div class="form-group mt-3">
													...
													<img id="output" class="width-100" style="width: 100px"
														src="<c:url value="
														/assets/user/img/category/${crrBean.image}" />"
													alt="No Image" />
												</div>
											</c:if>
											<div class="form-group mt-3">
												<label for="image" class="mb-2 fw-bold">Hình ảnh</label>
												<form:input id="image" type="file" class="form-control" accept="image/*"
													path="fileImage" />
											</div>
