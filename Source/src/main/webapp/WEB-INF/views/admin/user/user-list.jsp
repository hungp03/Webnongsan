										...
										<nav aria-label="breadcrumb">
											<ol class="breadcrumb mb-0 text-muted fs-6 fw-semibold">
												<li class="breadcrumb-item  "><a href="index.htm"
													class="text-decoration-none brc-link">Dashboard </a></li>
												<li class="breadcrumb-item active" aria-current="page"
													class="text-decoration-none">${role }</li>
											</ol>
										...
										<div class="row justify-content-between">
											<div class="col-lg-4 col-md-6 col-12 mb-2 mb-md-0">
												<form class="d-flex" role="search"
													action="admin/user/${source }">
													<input class="form-control" type="search"
														placeholder="Search ${role } by name or email" aria-label="Search"
											...
											<div class="col-xl-2 col-md-4 col-12">
												...
												<div>
													<a href="admin/user/create-${role.toLowerCase()}.htm"
														class="btn btn-custom">Add New ${role}</a>
								...
								<c:forEach varStatus="status" var="account" items="${accounts}">
									<tr>
										...
										<td class="align-middle"><a
											href="admin/user/changestatus.htm?id=${account.accountId }"><button
