													...
													<div class="col-xl-2 col-md-4 col-12 d-flex flex-col">
														...
														<div class="dropdown">
															...
															<ul class="dropdown-menu">
																...
																<li><a class="dropdown-item"
																		href="admin/orders.htm?filter=1">Chờ xử lý</a>
																</li>
																<li><a class="dropdown-item"
																		href="admin/orders.htm?filter=2">Đang giao</a>
																</li>
																<li><a class="dropdown-item"
																		href="admin/orders.htm?filter=3">Đã giao</a>
																</li>
																<li><a class="dropdown-item"
														...
														<tr>
															...
															<td class="align-middle">
																<div class="dropdown">
																	...
																	<ul class="dropdown-menu">
																		<li>
																			<form action="admin/orders/update-order.htm"
																				method="post">
