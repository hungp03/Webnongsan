												...
												<div class="dropdown">
													...
													<ul class="dropdown-menu">
														<li><a class="dropdown-item"
															href="employee/orders.htm?filter=0">All</a></li>
														<li><a class="dropdown-item"
															href="employee/orders.htm?filter=1">Unresolved</a></li>
														<li><a class="dropdown-item"
															href="employee/orders.htm?filter=2">On Moving</a></li>
														<li><a class="dropdown-item"
															href="employee/orders.htm?filter=3">Success</a></li>
														<li><a class="dropdown-item"
															href="employee/orders.htm?filter=4">Cancel</a></li>
											...
											<c:forEach varStatus="status" var="item" items="${orders}">
												<tr>
													<td class="align-middle"><a
														href="employee/orders/order-detail.htm?orderId=${item.orderId }" class="btn btn-outline-info btn-sm">View</a></td>
													...
													<td class="align-middle"><div class="dropdown">
															...
															<ul class="dropdown-menu">
																<li><a
																	...
																	href="employee/orders/update-order.htm?id=${item.orderId }&status=0">Unresolved</a></li>
																<li><a
																	class="dropdown-item ${item.status == 2 ? 'disabled' : '' }"
																	href="employee/orders/update-order.htm?id=${item.orderId }&status=1">On
																		Moving</a></li>
																<li><a
																	class="dropdown-item  ${item.status == 3 ? 'disabled' : '' }"
																	href="employee/orders/update-order.htm?id=${item.orderId }&status=2">Success</a></li>
																<li><a
																	class="dropdown-item ${item.status == 2 ? 'disabled' : '' }"
																	href="employee/orders/update-order.htm?id=${item.orderId }&status=3">Cancel</a></li>
							...
							<nav>
								<ul class="pagination d-flex justify-content-center ms-2">
									<li
										...
										href="employee/orders.htm?crrPage=${crrPage - 1}"> <span
									...
									<c:forEach var="i" begin="1" end="${paginate.totalPage }"
										...
										<li class="page-item "><a
											...
											href="employee/orders.htm?crrPage=${in.count}">${in.count}</a></li>
									</c:forEach>
									<li class="page-item"><a
										class="page-link mx-1 text-body ${(paginate.currentPage == paginate.totalPage) ? 'disabled' : '' }"
										aria-label="Next"
										href="employee/orders.htm?crrPage=${paginate.currentPage + 1}">
