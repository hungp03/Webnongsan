															...
															<div class="d-flex align-items-center mb-2 mb-md-0">
																...
																<c:choose>
																	<c:when test="${order.status == 0 }">
																		...
																		<c:set var="namestatus" value="Chờ xử lý">
																		</c:set>
																	</c:when>
																	<c:when test="${order.status == 1 }">
																		<c:set var="bargecolor" value="primary"></c:set>
																		<c:set var="namestatus" value="Đang giao">
																		</c:set>
																	</c:when>
																...
																<span
																	class="badge badge-${bargecolor } ml-3">${namestatus
																	}</span>
															</div>
															...
															<div class="row">
																...
																<div class="col-lg-4 col-md-4 col-12">
																	<div class="mb-6 mt-3">
																		...
																		<p class="mb-1 lh-lg">
																			${order.account.getName()
																			}<br>${order.account.email }<br>
																...
																<div class="col-lg-4 col-md-4 col-12">
																	<div class="mb-6 mt-3">
																		...
																		<p class="mb-1 lh-lg">${order.defaultAddress }
																		</p>
																...
																<div class="col-lg-4 col-md-4 col-12">
																	<div class="mb-6 mt-3">
																		<h6>Chi tiết</h6>
																		<p class="mb-1 lh-lg">
																			Ngày đặt hàng: <span class="text-dark">
																				<fmt:formatDate pattern="dd-MM-yyyy"
																					value="${order.orderTime}" />
																			</span><br>
																			Tổng tiền: <span class="text-dark">
																...
																<table class="table mb-0 text-nowrap table-centered">
																	...
																	<tbody>
																		...
																		<tr>
																			...
																			<td class="border-bottom-0 pb-0"></td>
																			<td colspan="1"
																				class="fw-medium text-dark ">Tạm
																				tính</td>
																			<td class="fw-medium text-dark ">
																				<fmt:formatNumber
																					value="${order.price - 15000}"
																					type="currency" currencySymbol="đ"
																					maxFractionDigits="0" />
																			</td>
																		</tr>
																		<tr>
																			...
																			<td class="border-bottom-0 pb-0"></td>
																			<td colspan="1"
																				class="fw-medium text-dark ">Phí
																				vận chuyển</td>
																			<td class="fw-medium text-dark  ">
																				<fmt:formatNumber value="${15000}"
																					type="currency" currencySymbol="đ"
																					maxFractionDigits="0" />
																			</td>
																		</tr>
													...
													<div class="card-body p-6">
														<div class="row">
															<div class="col-md-6 mb-4 mb-lg-0">
																...
																<c:choose>
																	<c:when
																		test="${order.paymentMethod.trim() eq 'BANKING'}">
																		<c:set var="pm"
																			value="Chuyển khoản ngân hàng" />
																	</c:when>
																	<c:when
																		test="${order.paymentMethod.trim() eq 'COD'}">
																		<c:set var="pm"
